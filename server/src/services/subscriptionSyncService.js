...
const BUYER_PLANS = new Set(['BUYER_STANDARD', 'BUYER_MONTHLY', 'BUYER_ANNUAL', 'BUYER_LIFETIME', 'BOTH_MONTHLY', 'BOTH_ANNUAL', 'BOTH_LIFETIME', 'BOTH_STANDARD_MONTH', 'BOTH_LIFETIME_LIFETIME', 'BOTH_LIFETIME_MONTH', 'BOTH_STANDARD_LIFETIME'])
const SELLER_PLANS = new Set(['SELLER_MONTH', 'SELLER_MONTHLY', 'SELLER_ANNUAL', 'SELLER_LIFETIME', 'BOTH_MONTHLY', 'BOTH_ANNUAL', 'BOTH_LIFETIME', 'BOTH_STANDARD_MONTH', 'BOTH_LIFETIME_LIFETIME', 'BOTH_LIFETIME_MONTH', 'BOTH_STANDARD_LIFETIME'])
